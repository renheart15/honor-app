                    ...
                    <?php else: ?>
                        <div class="space-y-4">
                            <?php foreach ($notifications as $notification): ?>
                                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow <?php echo $notification['is_read'] ? '' : 'border-l-4 border-l-primary-500'; ?>">
                                        ...
                                        <div class="ml-4 flex space-x-2">
                                            <?php if (!$notification['is_read']): ?>
                                                <form method="POST" class="inline">
                                                    ...
                                                    <button type="submit" class="text-primary-600 hover:text-primary-700 p-2 rounded-lg hover:bg-primary-50" title="Mark as read">
