...
// Get notifications
$notifications = $notificationManager->getUserNotifications($adviser_id, 5);
$unread_count = $notificationManager->getUnreadCount($adviser_id);
                        ...
                        <div class="relative">
                            ...
                            <div id="profileDropdown" class="hidden absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-200 z-50">
                                ...
                                <div class="py-2">
                                    ...
                                    <a href="submissions.php" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                        <i data-lucide="file-text" class="w-4 h-4 mr-3 text-gray-400"></i>
                                        Grade Submissions
                                    </a>
