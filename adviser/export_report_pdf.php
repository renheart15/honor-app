...
$adviser_query = "SELECT first_name, middle_name, last_name FROM users WHERE id = :adviser_id";
...
$adviser_name = strtoupper($adviser_info['first_name'] . ' ' .
                               ($adviser_info['middle_name'] ? substr($adviser_info['middle_name'], 0, 1) . '. ' : '') .
                               $adviser_info['last_name']);
...
$html .= '
    ...
    <div class="footer-section">
        ...
        <br/>
        <p style="font-weight: bold; margin: 0; padding: 0;">' . htmlspecialchars($adviser_name) . '</p>
        <p style="margin: 0; padding: 0;">Adviser, ' . htmlspecialchars($department) . '</p>
    </div>
</body>
</html>';
