        ...
        <div class="hidden md:flex md:w-64 md:flex-col">
            <div class="flex flex-col flex-grow bg-white border-r border-gray-200 pt-5 pb-4 overflow-y-auto">
                ...
                <nav class="mt-8 flex-1 px-2 space-y-1">
                    ...
                    <a href="notifications.php" class="bg-purple-50 border-r-2 border-purple-600 text-purple-700 group flex items-center px-2 py-2 text-sm font-medium rounded-l-xl">
                        <i data-lucide="bell" class="text-purple-500 mr-3 h-5 w-5"></i>
                        Notifications
                        <?php if ($unread_count > 0): ?>
                            <span class="ml-auto bg-purple-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                    ...
                    <div class="flex items-center space-x-4">
                        <?php if ($unread_count > 0): ?>
                            <form method="POST" class="inline">
                                ...
                                <button type="submit" class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-xl text-sm font-medium transition-colors">
                    ...
                    <?php else: ?>
                        <div class="space-y-4">
                            <?php foreach ($notifications as $notification): ?>
                                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow <?php echo $notification['is_read'] ? '' : 'border-l-4 border-l-purple-500'; ?>">
                                        ...
                                        <div class="ml-4 flex space-x-2">
                                            <?php if (!$notification['is_read']): ?>
                                                <form method="POST" class="inline">
                                                    ...
                                                    <button type="submit" class="text-purple-600 hover:text-purple-700 p-2 rounded-lg hover:bg-purple-50" title="Mark as read">
