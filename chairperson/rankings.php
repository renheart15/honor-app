...
foreach ($students as $student) {
    if ($student['gwa'] !== null) {
        $rankings[] = [
            ...
            'rank_position' => 0, // Will be set in display loop
            'total_students' => count($students),
            'percentile' => 0 // Will be calculated in display
        ];
    }
}
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-3">
                                    <input type="text" id="search" placeholder="Search students..." value="<?php echo htmlspecialchars($search); ?>"
                                           class="px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors w-64">
                                </div>
                            </div>
                        </header>
                        <div class="p-6">
                            ...
                            <div class="text-center py-12">
                                ...
                                <p class="text-gray-500">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php if (isset($debug_message)): ?>
                                            <br><small class="text-xs text-gray-400 mt-2 block">Debug: <?php echo htmlspecialchars($debug_message); ?></small>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                </p>
                            </div>
